...
// ============================================================================
// VLQ-P LINKING (which VLQ-P subtype for each encoded field)
// ============================================================================

/**
 * VLQ-P subtype assignments for encoded fields.
 * 
 * The "linking problem": determining which VLQ-P subtype (set of stage_bits)
...
// Field → VLQ-P subtype mapping (indices into VLQP_* constants)
// TODO: Replace with empirically-tuned assignments after profiling
#define SSK_VLQP_PARTITION_DELTA   VLQP_LARGE_INT    // Placeholder: skewed toward 0, tail to 2^32
#define SSK_VLQP_SEGMENT_COUNT     VLQP_SMALL_INT    // Placeholder: expect 1-10 typical
#define SSK_VLQP_INITIAL_DELTA     VLQP_LARGE_INT    // Placeholder: often 0, occasional gaps
#define SSK_VLQP_LENGTH_BITS       VLQP_MEDIUM_INT   // Placeholder: 64-2048 typical
#define SSK_VLQP_POPCOUNT          VLQP_MEDIUM_INT   // Placeholder: wide variance
#define SSK_VLQP_RAW_RUN_LEN       VLQP_SMALL_INT    // Placeholder: 1-5 typical
#define SSK_VLQP_ENUM_COMBINED     VLQP_LARGE_INT    // Placeholder: wide range due to k+rank
...
typedef enum {
    ...
    SSK_VALIDATE_VLQ_MINIMAL    = 0x01,  // Check VLQ minimality
...
#ifdef NDEBUG
#define SSK_VALIDATE_DEFAULT  (SSK_VALIDATE_VLQ_MINIMAL | SSK_VALIDATE_ORDERING)
#else
